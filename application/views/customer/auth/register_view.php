				...
				<div class="card o-hidden border-0 shadow-lg my-5">
					<div class="card-body p-0">
						...
						<div class="row" style="background-color: #F5F5DC;">
							<div class="col-lg-5 d-none d-lg-block bg-register-image" style="background-image: url('https://cdn.pixabay.com/photo/2017/03/12/09/38/cat-2136663_1280.jpg'); background-size: cover;">
							</div>
							<div class="col-lg">
								<div class="p-5">
