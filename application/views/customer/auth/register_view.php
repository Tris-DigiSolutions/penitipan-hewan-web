					...
					<div class="card-body p-0">
						...
						<div class="row" style="background-color: #F5F5DC;">
							<div class="col-lg-5 d-none d-lg-block bg-register-image"
								style="background-image: url('https://cdn.pixabay.com/photo/2017/03/12/09/38/cat-2136663_1280.jpg'); background-size: cover;">
							</div>
							<div class="col-lg">
								<div class="p-5">
									...
									<form class="user" action="<?= base_url("register") ?>" method="POST">
										<div class="form-group">
											<input type="text"
												class="form-control form-control-user <?= form_error('name') ? 'is-invalid' : ''; ?>"
												id="name" name="name" placeholder="Nama Lengkap" autofocus>
											<?= form_error('name', '<div class="invalid-feedback font-weight-bold pl-1">', '</div>') ?>
										</div>
										<div class="form-group">
											<input type="number"
												class="form-control form-control-user <?= form_error('phone') ? 'is-invalid' : ''; ?>"
												id="phone" name="phone" placeholder="Nomor Ponsel" autofocus>
											<?= form_error('phone', '<div class="invalid-feedback font-weight-bold pl-1">', '</div>') ?>
										</div>
										<div class="form-group">
											<input type="text"
												class="form-control form-control-user <?= form_error('address') ? 'is-invalid' : ''; ?>"
												id="address" name="address" placeholder="Alamat" autofocus>
									...
									<hr>
									<div class="text-center">
										<span class="small">Sudah punya akun? <a
												href="<?= base_url("login") ?>">Login</a></span>
									</div>
								</div>
							</div>
						</div>
