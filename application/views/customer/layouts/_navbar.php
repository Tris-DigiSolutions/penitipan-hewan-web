<nav class="navbar navbar-expand-lg navbar-dark fixed-top py-3 shadow">
	<div class="container">
		<img src="<?= base_url("assets/customer/img/pet-pet.png") ?>" height="30px"><a
			class="navbar-brand font-weight-bold" href="<?= base_url() ?>">PetShop</a>
		...
		<div class="collapse navbar-collapse" id="navbarResponsive">
			<ul class="navbar-nav ml-auto">
				<li class="nav-item active align-self-center">
					<a class="nav-link" href="<?= base_url() ?>" alt="Home" title="Home"
						style="display: flex;justify-content: center;align-items: center;"><svg
				...
				<li class="nav-item align-self-center">
					<a class="nav-link" href="<?= base_url("grooming/register") ?>" title="Grooming"
						style="display: flex;justify-content: center;align-items: center;"><svg
							xmlns="http://www.w3.org/2000/svg" height="16" width="18" viewBox="0 0 576 512"
							style="margin-right: 3px;">
							<!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2023 Fonticons, Inc.-->
				...
				<li class="nav-item align-self-center">
					<a class="nav-link" href="#features" title="Features"
						style="display: flex;justify-content: center;align-items: center;"><svg
							xmlns="http://www.w3.org/2000/svg" height="16" width="18" viewBox="0 0 576 512"
							style="margin-right: 3px;">
							<!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2023 Fonticons, Inc.-->
				...
				<li class="nav-item align-self-center">
					<a href="#carabooking" class="nav-link" title="CaraBooking"
						style="display: flex;justify-content: center;align-items: center;"><svg
							xmlns="http://www.w3.org/2000/svg" height="16" width="18" viewBox="0 0 576 512"
							style="margin-right: 3px;">
							<!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2023 Fonticons, Inc.-->
				...
				<li class="nav-item align-self-center">
					<a class="nav-link" href="#galleri" alt="Home" title="Galleri"
						style="display: flex;justify-content: center;align-items: center;"><svg
				...
				<?php if ($this->session->userdata("logged_in") == "customer"): ?>
					...
					<li class="nav-item dropdown align-self-center">
						<a class="nav-link" href="details.html#" id="navbarDropdown" role="button" data-toggle="dropdown"
							aria-haspopup="true" aria-expanded="false">
							<img src="<?= base_url("assets/uploads/avatars/" . $this->session->userdata("avatar")); ?>"
								alt="" class="rounded-circle profile-picture"
								style="height: 38px; width: 38px; object-fit: cover; object-position: center; border: 1px solid white;" />
						</a>
				...
				<?php else: ?>
					<div class="nav-item align-self-center">
						<a href="<?= base_url("login"); ?>"
							class="btn btn-primary px-4 text-white shadow text-uppercase">Login</a>
					</div>
				<?php endif; ?>
			</ul>
		</div>
