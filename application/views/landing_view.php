			...
			<div class="col-lg-12">
				...
				<section>
					...
					<div class="container px-4 py-5 border-bottom" id="featured-3">
						...
						<div class="d-md-flex flex-md-equal w-100 my-md-3 pl-md-3">
							...
							<div class="bg-light mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
								...
								<div class="bg-dark shadow-sm mx-auto"
									style="width: 80%; height: 300px; border-radius: 21px 21px 0 0; background-image: url('https://cdn.pixabay.com/photo/2017/08/07/19/46/shop-2607121_1280.jpg'); background-size: cover;background-repeat: no-repeat; background-position: bottom;">
								</div>
							</div>
						</div>
					</div>
					...
					<div class="container border-bottom">
						<div class="text-center mb-5 mt-5" id="features">
							<h2 class="text-base font-weight-bold leading-7 text-primary">Fitur Utama</h2>
							<p class="mt-2 text-gray-900">
								Fitur-fitur yang kami miliki</p>
						</div>
						<div class="row mt-3">
							<div class="col-lg-4 text-center">
								<svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor"
									class="bi bi-cart mb-2" viewBox="0 0 16 16">
									<path
								...
								<div class="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg"
									...
									<div class="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1">
										...
										<ul class="d-flex list-unstyled mt-auto">
											<li class="me-auto">
												<img src="https://pbs.twimg.com/media/DpNiWO7UcAUQKEq.png" alt="BSI"
