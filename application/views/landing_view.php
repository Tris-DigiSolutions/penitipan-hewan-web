					...
					<div class="container">
						<div class="row gy-4">
							<div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
								<h2 class="font-weight-bold mb-2 text-primary">Layanan Penitipan Hewan Terpercaya dan Nyaman
								</h2>
								<p class="text-">Tempat Terbaik ntuk Menitipkan Hewan Kesayanganmu</p>
								<div>
									<a href="grooming/register" class="btn btn-primary px-4 font-weight-bold text-white shadow text-uppercase mt-2">Booking Sekarang</a>
								</div>
							</div>
				...
				<section>
					...
					<div class="container px-4 py-5 border-bottom" id="featured-3">
						...
						<div class="d-md-flex flex-md-equal w-100 my-md-3 pl-md-3">
							<div class="bg-light mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
								...
								<div class="bg-dark shadow-sm mx-auto" style="width: 80%; height: 300px; border-radius: 21px 21px 0 0; background-image: url('https://cdn.pixabay.com/photo/2020/01/19/16/44/cat-4778387_1280.jpg'); background-size: cover;background-repeat: no-repeat;">
								</div>
							</div>
							<div class="bg-primary mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden">
								...
								<div class="bg-light shadow-sm mx-auto" style="width: 80%; height: 300px; border-radius: 21px 21px 0 0; background-image: url('https://cdn.pixabay.com/photo/2019/09/04/13/48/team-4451672_1280.jpg'); background-size: cover;background-repeat: no-repeat; background-position: bottom;">
								</div>
							</div>
							<div class="bg-light mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
								<div class="my-3 p-3">
								...
								<div class="bg-dark shadow-sm mx-auto" style="width: 80%; height: 300px; border-radius: 21px 21px 0 0; background-image: url('https://cdn.pixabay.com/photo/2023/10/21/06/34/european-shorthair-8330819_1280.jpg'); background-size: cover;background-repeat: no-repeat; background-position: bottom;">
								</div>
							</div>
						</div>
					</div>
					...
					<div class="container border-bottom py-5" id="features">
						...
						<div class="row">
							<div class="col-lg-4 text-center">
								...
								<h4 class="fw-normal text-primary">Kemudahan Pemesanan</h4>
								<p>Pesan layanan penitipan hewan dengan mudah melalui website kami</p>
							</div>
							<div class="col-lg-4 text-center">
								<svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-alarm mb-2" viewBox="0 0 16 16">
							...
							<div class="col-lg-4 text-center">
								<svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-house-check mb-2" viewBox="0 0 16 16">
						...
						<div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
							<div class="col d-flex align-items-start">
								<div class="icon-square text-body-emphasis bg-body-secondary d-inline-flex align-items-center justify-content-center fs-4 flex-shrink-0 me-3">
									<svg xmlns="http://www.w3.org/2000/svg" width="100" height="80" fill="currentColor" class="bi bi-1-square-fill" viewBox="0 0 16 16">
							...
							<div class="col d-flex align-items-start">
								<div class="icon-square text-body-emphasis bg-body-secondary d-inline-flex align-items-center justify-content-center fs-4 flex-shrink-0 me-3">
									<svg xmlns="http://www.w3.org/2000/svg" width="100" height="80" fill="currentColor" class="bi bi-2-square-fill" viewBox="0 0 16 16">
							...
							<div class="col d-flex align-items-start">
								<div class="icon-square text-body-emphasis bg-body-secondary d-inline-flex align-items-center justify-content-center fs-4 flex-shrink-0 me-3">
									<svg xmlns="http://www.w3.org/2000/svg" width="100" height="80" fill="currentColor" class="bi bi-3-square-fill" viewBox="0 0 16 16">
					...
					<div class="container px-4 py-5 border-bottom" id="galleri">
						...
						<div class="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-5">
							<div class="col">
								<div class="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg" style="background-image: url('https://cdn.pixabay.com/photo/2024/02/17/00/18/cat-8578562_1280.jpg'); background-size: cover;">
									<div class="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1">
										<h3 class="pt-5 mt-5 mb-4 display-6 lh-1 fw-bold">Mpus</h3>
										<ul class="d-flex list-unstyled mt-auto">
											<li class="me-auto">
												<img src="https://pbs.twimg.com/media/DpNiWO7UcAUQKEq.png" alt="BSI" width="32" height="32" class="rounded-circle border border-white">
											</li>
							...
							<div class="col">
								<div class="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg" style="background-image: url('https://cdn.pixabay.com/photo/2023/05/20/16/35/dog-8006807_1280.jpg'); background-size: cover;">
									<div class="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1">
							...
							<div class="col">
								<div class="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg" style="background-image: url('https://cdn.pixabay.com/photo/2014/04/13/20/49/cat-323262_1280.jpg'); background-size: cover;">
					...
					<div class="container my-5" style="background-color: rgb(248, 249, 250) ;">
						<div class="p-5 text-center bg-body-tertiary rounded-3">
							...
							<div class="d-inline-flex gap-2 mb-5">
								<button class="d-inline-flex align-items-center btn btn-primary btn-lg px-4 rounded-pill" type="button"> <a class="text-white" href="grooming/register">
										Pesan Sekarang
									</a>
								</button>
							</div>
