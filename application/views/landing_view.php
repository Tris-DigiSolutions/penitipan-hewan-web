					...
					<div class="container">
						<div class="row gy-4">
							<div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
								...
								<p class="text-">Tempat Terbaik Untuk Menitipkan Hewan Kesayanganmu</p>
								<div>
									<a href="grooming/register" class="btn btn-primary px-4 font-weight-bold text-white shadow text-uppercase mt-2">Booking
										Sekarang</a>
								</div>
							</div>
